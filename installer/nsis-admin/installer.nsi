...
# Name des Installers
Outfile "LuajitSetup_Admin.exe"

# Verzeichnis, in das installiert wird (Systemweit)
InstallDir "$PROGRAMFILES\@shadowdara\luajit"

RequestExecutionLevel admin   ; <<< Administratorrechte notwendig
...
# -------------------------------
# Funktion: AddToPath (System-PATH)
# -------------------------------
Function AddToPath
  Exch $1 ; new path
  Exch
